    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.registerUser) {
                ...
                Toast.error({description: '添加失败,用户名或邮箱被占用'})
            }
        })(dispatch, getState);
    };
}
    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.updateUserInfo) {
                Toast.success({description: '修改成功'})
                dispatch({
    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.updateSelfInfo) {
                ...
                Toast.error({description: '修改失败，请检查邮箱是否被占用'})
            }
        })(dispatch, getState);
    }
}
    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.updateUserPassword) {
                Toast.success({description: '修改密码成功'})
                dispatch({
                    type: actionTypes.updateSuccess
                })
            } else {
                ...
                Toast.error({description: '旧密码验证错误'})
            }
        })(dispatch, getState);
    };
}
