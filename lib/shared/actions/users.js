    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.registerUser) {
                console.success({description: '添加成功'})
                dispatch({
                ...
                console.error({description: '添加失败,用户名或邮箱被占用'})
            }
        })(dispatch, getState);
    };
}
    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.updateUserInfo) {
                console.success({description: '修改成功'})
                dispatch({
    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.updateSelfInfo) {
                ...
                console.error({description: '修改失败，请检查邮箱是否被占用'})
            }
        })(dispatch, getState);
    }
}
    ...
    return (dispatch, getState) => {
        ...
        return mutation({
            ...
            if (result.updateUserPassword) {
                console.success({description: '修改密码成功'})
                dispatch({
                    type: actionTypes.updateSuccess
                })
            } else {
                ...
                console.error({description: '旧密码验证错误'})
            }
        })(dispatch, getState);
    };
}
